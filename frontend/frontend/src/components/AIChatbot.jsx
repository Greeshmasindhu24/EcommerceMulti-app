...
const AIChatbot = () => {
  ...
  const [messages, setMessages] = useState([
    { text: "Hi! I'm the STYLE Multi-Agent assistant. I answer using our live product catalog and your orders (when logged in). Try: 'show all products', 'iPhone price', or 'return policy'.", isUser: false, agent: "System" }
  ]);
      ...
      <div className={`chat-window glass-panel ${!isOpen ? 'hidden' : ''}`}>
        <div className="chat-header">
          ...
          <div>
            ...
            <div style={{ fontSize: '0.8rem', color: 'var(--text-secondary)' }}>Multi-Agent · Router → Specialist</div>
          </div>
        </div>
